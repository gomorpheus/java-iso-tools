...
package com.morpheusdata.javaisotools.joliet.impl;

import java.util.HashMap;

import com.morpheusdata.javaisotools.iso9660.ISO9660RootDirectory;
import com.morpheusdata.javaisotools.iso9660.StandardHandler;
import com.morpheusdata.javaisotools.iso9660.impl.FileElement;
import com.morpheusdata.javaisotools.iso9660.volumedescriptors.SupplementaryVolumeDescriptor;
...
import com.morpheusdata.javaisotools.sabre.impl.ByteDataReference;
...
import com.morpheusdata.javaisotools.iso9660.impl.ISO9660Element;
import com.morpheusdata.javaisotools.iso9660.impl.ISO9660Factory;
import com.morpheusdata.javaisotools.iso9660.impl.LogicalSectorElement;
import com.morpheusdata.javaisotools.iso9660.sabre.impl.BothWordDataReference;
...
public class JolietHandler extends StandardHandler {
    ...
    public JolietHandler(StreamHandler streamHandler, ISO9660RootDirectory root, JolietConfig config)
        ...
        this.helper = new JolietLayoutHelper(this, jolietRoot, config.getMaxCharsInFilename(), config.getFailOnTruncation(), config.isForceDotDelimiter());
